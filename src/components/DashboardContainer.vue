<template>
  <dashboard-restore-panel :elements="restoreElements" @restore-element="showElement" />
  <div class="dashboard-container" ref="container">
    <draggable-resizable-container
        :grid="grid"
        :show-grid="true"
        class="dashboard-draggable-resizable"
    >
      <draggable-resizable-vue
          v-for="element in visibleElements"  :key="element.id" @mousedown="activateElement(element)" @mouseup="movingElement(element)"
          v-model:x="element.x"
          v-model:y="element.y"
      ...
      >
        <DashboardItem  style="overflow: hidden" :element="element" :is-body-draggable="true" @hide-element="hideElement(element)" />
      </draggable-resizable-vue>
    </draggable-resizable-container>
  </div>
</template>
